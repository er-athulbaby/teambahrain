...
export default async function HistoryPage() {
  const [timeline, legends] = await Promise.all([getTimeline(), getLegends()]);
      ...
      <section className="border-b-2 border-ink">
        <div className="max-w-[1400px] mx-auto px-4 sm:px-8 py-10 sm:py-14 flex flex-col gap-5">
          ...
          <p className="m-0 max-w-[60ch] text-lg sm:text-[19px] leading-[1.5] text-ink-800 text-pretty">
            From a committee formed in Manama to an Olympic title on the
            track in London — five decades of Bahraini sport, in order.
          </p>
        </div>
      </section>
