  ...
  game_editions: {
    ...
    fields: [
      ...
      { key: "logo_path", label: "Logo", type: "image" },
      {
        ...
        type: "select",
        required: true,
        options: ["draft", "announced", "live"],
        hint: "Draft: hidden. Announced: shows in Calendar/Games/Home but isn't clickable yet — no micro-site content. Live: fully clickable.",
      },
      { key: "sort_order", label: "Sort order", type: "number" },
    ],
  },
